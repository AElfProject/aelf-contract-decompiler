...
namespace AElfContractDecompiler.Models
{
    public static class DecoderConstants
    {
        ...
        public static readonly string ContractsPath = Path.Combine(UserPath, "AElf", "ContractsDecompiled");

        // directory of input dll
        public static readonly string DllPath = Path.Combine(UserPath, "AElf", "DllInputs");
    }
}